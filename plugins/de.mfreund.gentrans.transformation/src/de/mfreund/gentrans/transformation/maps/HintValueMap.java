...
public class HintValueMap<H extends EObject, V extends Object>
		extends HashMap<H, HashMap<SourceSectionClass, LinkedList<V>>> {

	private static final long serialVersionUID = 7863859419011070324L;

	/**
	 * This initializes this map. Optionally, an {@link #createEmptyValue() empty value} is added to the list of hint
	 * values.
	 * <p />
	 ...
	 * @param addEmptyValue
	 *            Whether an {@link #createEmptyValue() empty value} shall be added to the list.
	 */
	...
	/**
	 * This creates an {@link #createEmptyValue() empty value}. The default implementation of 'empty value' returns
	 * <em>null</em> but special definitions may be provided by implementing sub-classes. In most cases.
	 *
