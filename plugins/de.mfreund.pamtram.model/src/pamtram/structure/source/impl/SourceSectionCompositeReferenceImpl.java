 ...
 * </p>
 * <ul>
 * <li>{@link pamtram.structure.source.impl.SourceSectionCompositeReferenceImpl#isIgnoreUnmatchedElements
 * <em>Ignore Unmatched Elements</em>}</li>
 * <li>{@link pamtram.structure.source.impl.SourceSectionCompositeReferenceImpl#getEReference
 * <em>EReference</em>}</li>
 * </ul>
 *
 * @generated
...
public class SourceSectionCompositeReferenceImpl extends
	 ...
	 * @ordered
	 */
	protected boolean ignoreUnmatchedElements = SourceSectionCompositeReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT;
	...
	public EList<SourceSectionClass> getValue() {
		if (this.value == null) {
			this.value = new EObjectContainmentEList<>(SourceSectionClass.class, this,
					SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__VALUE);
		}
		return this.value;
	}
	...
	public void setIgnoreUnmatchedElements(boolean newIgnoreUnmatchedElements) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__IGNORE_UNMATCHED_ELEMENTS,
			...
			if (this.eReference != oldEReference) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE, oldEReference,
							this.eReference));
				}
			}
		}
	...
	public void setEReferenceGen(EReference newEReference) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE, oldEReference, this.eReference));
		}
	}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
			this.setIgnoreUnmatchedElements(SourceSectionCompositeReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT);
			return;
		case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
			return this.ignoreUnmatchedElements != SourceSectionCompositeReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT;
		case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SourceSectionReference.class) {
			...
			case SourcePackage.SOURCE_SECTION_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
				return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__IGNORE_UNMATCHED_ELEMENTS;
			default:
				return -1;
			}
		}
		if (baseClass == ActualReference.class) {
			...
			case GenericPackage.ACTUAL_REFERENCE__EREFERENCE:
				return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ActualReference.class) {
			...
			case GenericPackage.ACTUAL_REFERENCE___VALIDATE_EREFERENCE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP:
				return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE___VALIDATE_EREFERENCE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP;
			default:
				return -1;
			}
		}
