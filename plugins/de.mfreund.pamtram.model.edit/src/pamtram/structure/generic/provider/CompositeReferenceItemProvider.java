...
public class CompositeReferenceItemProvider extends ReferenceItemProvider {
		...
		this.itemPropertyDescriptors.add(
				new ItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
					...
					public Collection<?> getChoiceOfValues(Object object) {
						...
						return parent.getEClass().getEAllReferences().stream().filter(ref -> ref.isContainment())
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		if (object instanceof ActualReference<?, ?, ?, ?>
				&& ((ActualReference<?, ?, ?, ?>) object).getEReference().getUpperBound() < 0) {
