 ...
 * @generated
 */
public class AttributeMappingSourceElementItemProvider extends AttributeMappingSourceElementTypeItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AttributeMappingSourceElement_type") :
			getString("_UI_AttributeMappingSourceElement_type") + " " + label;
	}
