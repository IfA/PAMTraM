...
public class InstanceSelectorSourceElementItemProvider extends LocalDynamicSourceElementItemProvider {
	...
	/**
	 * This returns InstanceSelectorSourceElement.gif. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return this.overlayImage(object,
				this.getResourceLocator().getImage("full/obj16/InstanceSelectorSourceElement"));
	}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(this.getString("_UI_InstanceSelectorSourceElement_type"),
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InstanceSelectorSourceElement.class)) {
