 ...
 * </p>
 * <ul>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getLibraryFile <em>Library File</em>}</li>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getOriginalLibraryEntry <em>Original Library Entry</em>}</li>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getPath <em>Path</em>}</li>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getId <em>Id</em>}</li>
 *   <li>{@link pamtram.structure.impl.LibraryEntryImpl#getResourceParameters <em>Resource Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
