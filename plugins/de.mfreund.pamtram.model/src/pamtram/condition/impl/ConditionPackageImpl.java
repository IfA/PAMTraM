...
public class ConditionPackageImpl extends EPackageImpl implements ConditionPackage {
	 ...
	 * @generated
	 */
	public EOperation getMultipleConditionOperator__ReferenceOnlyConditionsFromConditionModel__DiagnosticChain_Map_1() {
	 ...
	 * @generated
	 */
	public EOperation getSingleConditionOperator__MinimalNumberOfArgs__DiagnosticChain_Map_1() {
	 ...
	 * @generated
	 */
	public EOperation getSingleConditionOperator__ReferenceOnlyConditionsFromConditionModelOrFromConditionalElements__DiagnosticChain_Map_1() {
	...
	public void createPackageContents() {
		...
		createEOperation(multipleConditionOperatorEClass, MULTIPLE_CONDITION_OPERATOR___REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP_1);
		...
		createEOperation(singleConditionOperatorEClass, SINGLE_CONDITION_OPERATOR___MINIMAL_NUMBER_OF_ARGS__DIAGNOSTICCHAIN_MAP_1);
		createEOperation(singleConditionOperatorEClass, SINGLE_CONDITION_OPERATOR___REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL_OR_FROM_CONDITIONAL_ELEMENTS__DIAGNOSTICCHAIN_MAP_1);
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getMultipleConditionOperator__ReferenceOnlyConditionsFromConditionModel__DiagnosticChain_Map_1(), ecorePackage.getEBoolean(), "referenceOnlyConditionsFromConditionModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getSingleConditionOperator__MinimalNumberOfArgs__DiagnosticChain_Map_1(), ecorePackage.getEBoolean(), "minimalNumberOfArgs", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getSingleConditionOperator__ReferenceOnlyConditionsFromConditionModelOrFromConditionalElements__DiagnosticChain_Map_1(), ecorePackage.getEBoolean(), "referenceOnlyConditionsFromConditionModelOrFromConditionalElements", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
