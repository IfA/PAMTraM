 ...
 * @generated
 */
public interface SourceSection extends SourceSectionClass, Section<SourceSection, SourceSectionClass, SourceSectionReference, ActualSourceSectionAttribute> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * mapping::MappingType.allInstances()->select(m | self = m.sourceMMSection)\n \052/\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.Executor%> executor = <%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%>.getExecutor(this);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = executor.getIdResolver();\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.Class%> TYP_pamtram_c_c_mapping_c_c_MappingType_0 = idResolver.getClass(<%pamtram.metamodel.MetamodelTables%>.CLSSid_MappingType, null);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.values.SetValue%> allInstances = <%org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation%>.INSTANCE.evaluate(executor, <%pamtram.metamodel.MetamodelTables%>.SET_CLSSid_MappingType, TYP_pamtram_c_c_mapping_c_c_MappingType_0);\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SetValue%>.Accumulator accumulator = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createSetAccumulatorValue(<%pamtram.metamodel.MetamodelTables%>.SET_CLSSid_MappingType);\n/*@NonNull\052/ <%java.util.Iterator%><<%java.lang.Object%>> ITERATOR_m = allInstances.iterator();\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SetValue%> select;\nwhile (true) {\n    if (!ITERATOR_m.hasNext()) {\n        select = accumulator;\n        break;\n    }\n    /*@NonInvalid\052/ <%pamtram.mapping.MappingType%> m = (<%pamtram.mapping.MappingType%>)ITERATOR_m.next();\n    /**\n     * self = m.sourceMMSection\n     \052/\n    final /*@Thrown\052/ <%pamtram.metamodel.SourceSection%> sourceMMSection = m.getSourceMMSection();\n    final /*@Thrown\052/ boolean eq = this.equals(sourceMMSection);\n    //\n    if (eq == <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE) {\n        accumulator.add(m);\n    }\n}\nfinal /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingType%>> ECORE_select = ((<%org.eclipse.ocl.pivot.ids.IdResolver%>.IdResolverExtension)idResolver).ecoreValueOfAll(<%pamtram.mapping.MappingType%>.class, select);\nreturn (<%org.eclipse.emf.common.util.EList%><<%pamtram.mapping.MappingType%>>)ECORE_select;'"
	 * @generated
	 */
