 ...
 * </p>
 * <ul>
 * <li>{@link pamtram.mapping.impl.MappingHintGroupImpl#isDeactivated
 * <em>Deactivated</em>}</li>
 * <li>{@link pamtram.mapping.impl.MappingHintGroupImpl#getLocalCondition
 * <em>Local Condition</em>}</li>
 * <li>{@link pamtram.mapping.impl.MappingHintGroupImpl#getSharedCondition
 * <em>Shared Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingHintGroupImpl extends MappingHintGroupTypeImpl implements MappingHintGroup {
	/**
	 * The default value of the '{@link #isDeactivated() <em>Deactivated</em>}'
	...
	/**
	 * The cached value of the '{@link #isDeactivated() <em>Deactivated</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see #isDeactivated()
	 * @generated
	 * @ordered
	 */
	protected boolean deactivated = MappingHintGroupImpl.DEACTIVATED_EDEFAULT;
	/**
	 * The cached value of the '{@link #getLocalCondition() <em>Local
	 * Condition</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	...
	/**
	 * The cached value of the '{@link #getSharedCondition() <em>Shared
	 * Condition</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	public void setDeactivated(boolean newDeactivated) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MAPPING_HINT_GROUP__DEACTIVATED,
	...
	public NotificationChain basicSetLocalCondition(ComplexCondition newLocalCondition, NotificationChain msgs) {
		...
		if (this.eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION, oldLocalCondition, newLocalCondition);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newLocalCondition != this.localCondition) {
			...
			if (this.localCondition != null) {
				msgs = ((InternalEObject) this.localCondition).eInverseRemove(this,
						InternalEObject.EOPPOSITE_FEATURE_BASE - MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION,
						null, msgs);
			}
			...
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION, newLocalCondition, newLocalCondition));
		}
	}
			...
			if (this.sharedCondition != oldSharedCondition) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MappingPackage.MAPPING_HINT_GROUP__SHARED_CONDITION, oldSharedCondition,
	...
	public void setSharedCondition(ComplexCondition newSharedCondition) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					MappingPackage.MAPPING_HINT_GROUP__SHARED_CONDITION, oldSharedCondition, this.sharedCondition));
		}
	}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case MappingPackage.MAPPING_HINT_GROUP__DEACTIVATED:
			this.setDeactivated(MappingHintGroupImpl.DEACTIVATED_EDEFAULT);
			return;
		case MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MappingPackage.MAPPING_HINT_GROUP__DEACTIVATED:
			return this.deactivated != MappingHintGroupImpl.DEACTIVATED_EDEFAULT;
		case MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DeactivatableElement.class) {
			...
			case PamtramPackage.DEACTIVATABLE_ELEMENT__DEACTIVATED:
				return MappingPackage.MAPPING_HINT_GROUP__DEACTIVATED;
			default:
				return -1;
			}
		}
		if (baseClass == ConditionalElement.class) {
			...
			case PamtramPackage.CONDITIONAL_ELEMENT__LOCAL_CONDITION:
				return MappingPackage.MAPPING_HINT_GROUP__LOCAL_CONDITION;
			case PamtramPackage.CONDITIONAL_ELEMENT__SHARED_CONDITION:
				return MappingPackage.MAPPING_HINT_GROUP__SHARED_CONDITION;
			default:
				return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == ConditionalElement.class) {
			...
			case PamtramPackage.CONDITIONAL_ELEMENT___VALIDATE_EITHER_MODEL_OR_REFER_CONDITION__DIAGNOSTICCHAIN_MAP:
				return MappingPackage.MAPPING_HINT_GROUP___VALIDATE_EITHER_MODEL_OR_REFER_CONDITION__DIAGNOSTICCHAIN_MAP;
			case PamtramPackage.CONDITIONAL_ELEMENT___VALIDATE_REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP:
				return MappingPackage.MAPPING_HINT_GROUP___VALIDATE_REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP;
			default:
				return -1;
			}
		}
