 ...
 * </p>
 * <ul>
 *   <li>{@link pamtram.metamodel.impl.EndingMatcherImpl#getType <em>Type</em>}</li>
 *   <li>{@link pamtram.metamodel.impl.EndingMatcherImpl#getValue <em>Value</em>}</li>
 *   <li>{@link pamtram.metamodel.impl.EndingMatcherImpl#isCaseSensitive <em>Case Sensitive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndingMatcherImpl extends NamedElementImpl implements
		EndingMatcher {
	/**
	...
	public void setType(AttributeValueConstraintType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ENDING_MATCHER__TYPE, oldType, type));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.ENDING_MATCHER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.ENDING_MATCHER__TYPE:
				return getType();
			case MetamodelPackage.ENDING_MATCHER__VALUE:
				return getValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MetamodelPackage.ENDING_MATCHER___CHECK_CONSTRAINT__STRING:
