...
public class VirtualSourceSectionCrossReferenceItemProvider extends CrossReferenceItemProvider {
	...
	public Object getStyledText(Object object) {
		String label = ((VirtualSourceSectionCrossReference)object).getName();
    	StyledString styledLabel = new StyledString();
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_VirtualSourceSectionCrossReference_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_VirtualSourceSectionCrossReference_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}	
