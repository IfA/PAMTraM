...
public class CardinalityMappingImpl extends MappingHintImpl implements CardinalityMapping {
	 ...
	 * @ordered
	 */
	protected String expression = CardinalityMappingImpl.EXPRESSION_EDEFAULT;
	...
	public void setExpression(String newExpression) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.CARDINALITY_MAPPING__EXPRESSION,
	...
	public EList<ValueModifierSet> getModifiers() {
		...
		if (this.modifiers == null) {
			this.modifiers = new EObjectResolvingEList<>(ValueModifierSet.class, this,
					MappingPackage.CARDINALITY_MAPPING__MODIFIERS);
		}
	...
	public MetaModelElement<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute> getSource() {
		...
		if (this.source != null && this.source.eIsProxy()) {
			...
			this.source = (MetaModelElement<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute>) this
					.eResolveProxy(oldSource);
			if (this.source != oldSource) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MappingPackage.CARDINALITY_MAPPING__SOURCE, oldSource, this.source));
				}
			}
		}
		return this.source;
	...
	public void setSource(
		...
		MetaModelElement<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute> oldSource = this.source;
		this.source = newSource;
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.CARDINALITY_MAPPING__SOURCE,
	...
	public TargetSectionClass getTarget() {
		...
		if (this.target != null && this.target.eIsProxy()) {
			...
			this.target = (TargetSectionClass) this.eResolveProxy(oldTarget);
			if (this.target != oldTarget) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MappingPackage.CARDINALITY_MAPPING__TARGET, oldTarget, this.target));
				}
			}
		}
		return this.target;
	...
	public void setTarget(TargetSectionClass newTarget) {
		...
		TargetSectionClass oldTarget = this.target;
		this.target = newTarget;
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.CARDINALITY_MAPPING__TARGET,
	...
	public EList<CardinalityMappingSourceInterface> getSourceElements() {
		...
		if (this.sourceElements == null) {
			this.sourceElements = new EObjectContainmentEList<>(
					CardinalityMappingSourceInterface.class, this, MappingPackage.CARDINALITY_MAPPING__SOURCE_ELEMENTS);
		}
	...
	public boolean validateSourceElementMatchesSection(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		boolean result = this.getSource().getContainingSection() == ((Mapping) this.eContainer().eContainer())
				.getSourceSection();

		if (!result && diagnostics != null) {

			String errorMessage = "The source element '" + this.getSource().getName()
					+ "' is not part of the source section referenced by parent mapping '"
					+ ((pamtram.mapping.Mapping) this.eContainer().eContainer()).getName() + "'!";

			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_SOURCE_ELEMENT_MATCHES_SECTION, errorMessage,
	...
	public boolean validateTargetClassMatchesSection(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		boolean result = this.getTarget().getContainingSection() == ((MappingHintGroupType) this.eContainer())
				.getTargetSection();
		...
		if (!result && diagnostics != null) {
			...
			String errorMessage = "The target class '" + this.getTarget().getName()
					...
					+ ((MappingHintGroupType) this.eContainer()).getName() + "'!";

			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_TARGET_CLASS_MATCHES_SECTION, errorMessage,
	...
	public boolean validateSourceClassIsVariableCardinality(final DiagnosticChain diagnostics,
		...
		boolean result = this.getSource() == null || !(this.getSource() instanceof SourceSectionClass) ? true
				: ((SourceSectionClass) this.getSource()).getCardinality() != CardinalityType.ONE;
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_SOURCE_CLASS_IS_VARIABLE_CARDINALITY, errorMessage,
					new Object[] { this, MappingPackage.Literals.CARDINALITY_MAPPING__SOURCE }));
	...
	public boolean validateTargetClassIsVariableCardinality(final DiagnosticChain diagnostics,
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_TARGET_CLASS_IS_VARIABLE_CARDINALITY, errorMessage,
					new Object[] { this, MappingPackage.Literals.CARDINALITY_MAPPING__TARGET }));
	...
	public boolean validateNoCardinalityMappingForSourceSectionRoot(final DiagnosticChain diagnostics,
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					...
					errorMessage, new Object[] { this, MappingPackage.Literals.CARDINALITY_MAPPING__SOURCE }));
	...
	public boolean validateOnlySourceOrSourceElements(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		boolean result = this.getSource() == null || this.getSourceElements() == null
				|| this.getSourceElements().isEmpty();
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_ONLY_SOURCE_OR_SOURCE_ELEMENTS, errorMessage,
	...
	public boolean validateExpressionOnlyForSourceElements(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_EXPRESSION_ONLY_FOR_SOURCE_ELEMENTS, errorMessage,
					new Object[] { this, MappingPackage.Literals.CARDINALITY_MAPPING }));
	...
	public boolean validateModifiersOnlyForSourceElements(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		if (!result && diagnostics != null) {
			...
			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, MappingValidator.DIAGNOSTIC_SOURCE,
					MappingValidator.CARDINALITY_MAPPING__VALIDATE_MODIFIERS_ONLY_FOR_SOURCE_ELEMENTS, errorMessage,
					new Object[] { this, MappingPackage.Literals.CARDINALITY_MAPPING }));
	...
	public EList<CardinalityMappingSourceElement> getLocalSourceElements() {
		...
		return new BasicEList<>(
				this.getSourceElements().parallelStream().filter(s -> s instanceof CardinalityMappingSourceElement)
						.map(s -> (CardinalityMappingSourceElement) s).collect(Collectors.toList()));
	}
	...
	public EList<CardinalityMappingExternalSourceElement> getExternalSourceElements() {
		...
		return new BasicEList<>(this.getSourceElements().parallelStream()
				.filter(s -> s instanceof CardinalityMappingExternalSourceElement)
				.map(s -> (CardinalityMappingExternalSourceElement) s).collect(Collectors.toList()));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		switch (featureID) {
			...
			case MappingPackage.CARDINALITY_MAPPING__SOURCE:
				this.setSource(
						(MetaModelElement<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute>) newValue);
				return;
			case MappingPackage.CARDINALITY_MAPPING__TARGET:
				this.setTarget((TargetSectionClass) newValue);
				return;
			case MappingPackage.CARDINALITY_MAPPING__SOURCE_ELEMENTS:
				this.getSourceElements().clear();
				this.getSourceElements().addAll((Collection<? extends CardinalityMappingSourceInterface>) newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		...
		switch (featureID) {
			case MappingPackage.CARDINALITY_MAPPING__EXPRESSION:
				this.setExpression(CardinalityMappingImpl.EXPRESSION_EDEFAULT);
				return;
			case MappingPackage.CARDINALITY_MAPPING__MODIFIERS:
				this.getModifiers().clear();
				return;
			case MappingPackage.CARDINALITY_MAPPING__SOURCE:
				this.setSource(
						(MetaModelElement<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute>) null);
				return;
			case MappingPackage.CARDINALITY_MAPPING__TARGET:
				this.setTarget((TargetSectionClass) null);
				return;
			case MappingPackage.CARDINALITY_MAPPING__SOURCE_ELEMENTS:
				this.getSourceElements().clear();
				return;
	...
	public boolean eIsSet(int featureID) {
		...
		switch (featureID) {
			case MappingPackage.CARDINALITY_MAPPING__EXPRESSION:
				return CardinalityMappingImpl.EXPRESSION_EDEFAULT == null ? this.expression != null
						: !CardinalityMappingImpl.EXPRESSION_EDEFAULT.equals(this.expression);
			case MappingPackage.CARDINALITY_MAPPING__MODIFIERS:
		...
		if (baseClass == ExpressionElement.class) {
			switch (baseFeatureID) {
				case PamtramPackage.EXPRESSION_ELEMENT__EXPRESSION:
					return MappingPackage.CARDINALITY_MAPPING__EXPRESSION;
				default:
					return -1;
			}
		}
		if (baseClass == ModifiableElement.class) {
			switch (baseFeatureID) {
				case PamtramPackage.MODIFIABLE_ELEMENT__MODIFIERS:
					return MappingPackage.CARDINALITY_MAPPING__MODIFIERS;
				default:
					return -1;
			}
		}
