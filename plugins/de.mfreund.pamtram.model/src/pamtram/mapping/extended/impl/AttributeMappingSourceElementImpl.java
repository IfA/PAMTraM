...
public class AttributeMappingSourceElementImpl extends
	...
	public EList<SourceSectionReference> getReferenceMatchSpec() {
		if (referenceMatchSpec == null) {
			referenceMatchSpec = new EObjectResolvingEList<SourceSectionReference>(SourceSectionReference.class, this, ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__REFERENCE_MATCH_SPEC);
		}
	...
	public NotificationChain basicSetLocalCondition(ComplexCondition newLocalCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__LOCAL_CONDITION, oldLocalCondition, newLocalCondition);
	...
	public void setLocalCondition(ComplexCondition newLocalCondition) {
		if (newLocalCondition != localCondition) {
			...
			if (localCondition != null)
				msgs = ((InternalEObject)localCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__LOCAL_CONDITION, null, msgs);
			if (newLocalCondition != null)
				msgs = ((InternalEObject)newLocalCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__LOCAL_CONDITION, null, msgs);
			msgs = basicSetLocalCondition(newLocalCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__LOCAL_CONDITION, newLocalCondition, newLocalCondition));
	}
	...
	public ComplexCondition getSharedCondition() {
		if (sharedCondition != null && sharedCondition.eIsProxy()) {
			...
			if (sharedCondition != oldSharedCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__SHARED_CONDITION, oldSharedCondition, sharedCondition));
			}
		}
	...
	public void setSharedCondition(ComplexCondition newSharedCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedPackage.ATTRIBUTE_MAPPING_SOURCE_ELEMENT__SHARED_CONDITION, oldSharedCondition, sharedCondition));
	}
