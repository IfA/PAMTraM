...
/**
 */
package pamtram.structure.source.presentation;
...
/**
 * This is the action bar contributor for the Source model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceActionBarContributor
	 ...
	 * @generated
	 */
	public SourceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("source-settings"));
		toolBarManager.add(new Separator("source-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PamtramEditorPlugin.INSTANCE.getString("_UI_SourceEditor_menu"), "pamtram.structure.sourceMenuID");
