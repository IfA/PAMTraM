 ...
 * </p>
 * <ul>
 *   <li>{@link pamtram.structure.NonContainmentReference#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see pamtram.structure.MetamodelPackage#getNonContainmentReference()
 * @model abstract="true"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='eReferenceIsNonContainment'"
 * @generated
 */
public interface NonContainmentReference<S extends Section<S, C, R, A>, C extends pamtram.structure.Class<S, C, R, A>, R extends Reference<S, C, R, A>, A extends Attribute<S, C, R, A>> extends Reference<S, C, R, A> {
	 ...
	 * @see pamtram.structure.MetamodelPackage#getNonContainmentReference_Value()
	 * @model
	 * @generated
	 */
	EList<C> getValue();
