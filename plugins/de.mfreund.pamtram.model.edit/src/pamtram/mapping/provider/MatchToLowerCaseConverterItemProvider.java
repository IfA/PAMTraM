 ...
 * @generated
 */
public class MatchToLowerCaseConverterItemProvider extends AttributeValueModifierItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MatchToLowerCaseConverter_type") :
			getString("_UI_MatchToLowerCaseConverter_type") + " " + label;
	}
