...
public class GlobalDynamicSourceElementItemProvider extends DynamicSourceElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (this.childrenFeatures == null) {
			...
			this.childrenFeatures.add(StructurePackage.Literals.GLOBAL_DYNAMIC_SOURCE_ELEMENT__INSTANCE_SELECTORS);
		}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			...
			styledLabel
					.append(this.getString("_UI_GlobalDynamicSourceElement_type"), StyledString.Style.QUALIFIER_STYLER)
					.append(" " + label);
		}
		return styledLabel;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				this.createChildParameter(StructurePackage.Literals.GLOBAL_DYNAMIC_SOURCE_ELEMENT__INSTANCE_SELECTORS,
