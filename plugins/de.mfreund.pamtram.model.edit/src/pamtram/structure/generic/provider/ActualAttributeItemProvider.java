...
/**
 * This is the item provider adapter for a {@link pamtram.structure.generic.ActualAttribute} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ActualAttributeItemProvider extends AttributeItemProvider {
	...
	public Object getImage(Object object) {
		...
		return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ActualAttribute"));
	}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(this.getString("_UI_ActualAttribute_type"), StyledString.Style.QUALIFIER_STYLER);
		} else {
			styledLabel.append(this.getString("_UI_ActualAttribute_type"), StyledString.Style.QUALIFIER_STYLER)
					.append(" " + label);
		}
