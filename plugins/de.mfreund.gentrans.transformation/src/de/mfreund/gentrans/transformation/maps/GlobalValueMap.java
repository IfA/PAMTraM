...
/**
 * This is used to store values of {@link FixedValue FixedValues} and
 * {@link GlobalAttribute GlobalAttributes} that can be used throughout the
 * transformation.
 *
 * @author mfreund
 *
...
public class GlobalValueMap {
	...
	/**
	 * This keeps track of the values of {@link GlobalAttribute
	 * GlobalAttributes}.
	 */
	private Map<GlobalAttribute, String> globalAttributes;

	/**
	 * This keeps track of both {@link FixedValue FixedValues} and
	 * {@link GlobalAttribute GlobalAttributes}.
	 */
	private Map<NamedElement, String> globalValues;

	/**
	 * This keeps track of a those of the {@link #globalValues} that can be
	 * parsed as double.
	 */
	 ...
	 * @return The value or '<em><b>null</b></em> if no value for the given
	 *         <em>fixedValue</em> exists.
	 */
	 ...
	 *
	 * @return The values of the {@link FixedValue FixedValues} modeled in the
	 *         PAMTraM model.
	 */
	 ...
	 *
	 * @return The extracted values of the {@link GlobalAttribute
	 *         GlobalAttributes} modeled in the PAMTraM model.
	 */
	 ...
	 *
	 * @return The values of both {@link FixedValue FixedValues} and
	 *         {@link GlobalAttribute GlobalAttributes}.
	 */
	...
	/**
	 * This returns the values of the {@link #globalValues} as {@link Double}
	 * values that can be used in calculations.
	 * <p />
	 * Therefore, it tries to parse a <em>double</em> value for each of the
	 * {@link #globalValues}. Values that cannot be parsed as <em>double</em>
	 * are ignored.
	 *
	 * @return The values of both {@link FixedValue FixedValues} and
	 *         {@link GlobalAttribute GlobalAttributes} represented as
	 *         <em>double</em>.
	 */
		...
		if (this.globalValuesAsDouble == null) {
			...
			this.globalValues.entrySet().stream().forEach(globalValue -> {
				...
				try {
					...
					/*
					 * We make use of the ExpressionBuilder as
					 * 'String.valueOf(double)' doesn't support scientific
	...
	/**
	 * This returns the values of the {@link #globalValues} as {@link Double}
	 * values that can be used in calculations. Thereby, the
	 * {@link NamedElement#getName() names} of the respective elements are used
	 * as key in the returned map.
	 *
	 * @see #getAsDouble()
	 *
	 * @return The values of both {@link FixedValue FixedValues} and
