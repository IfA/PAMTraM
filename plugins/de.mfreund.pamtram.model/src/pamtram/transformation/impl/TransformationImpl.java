...
public class TransformationImpl extends MinimalEObjectImpl.Container implements Transformation {
	/**
	 * The cached value of the '{@link #getTransformationMapping() <em>Transformation Mapping</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<TransformationMapping> transformationMapping;
	 ...
	 * @generated
	 */
	public EList<TransformationMapping> getTransformationMapping() {
		if (transformationMapping == null) {
			transformationMapping = new EObjectContainmentEList<TransformationMapping>(TransformationMapping.class, this, TransformationPackage.TRANSFORMATION__TRANSFORMATION_MAPPING);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TransformationPackage.TRANSFORMATION__TRANSFORMATION_MAPPING:
				return ((InternalEList<?>)getTransformationMapping()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TransformationPackage.TRANSFORMATION__TRANSFORMATION_MAPPING:
				return getTransformationMapping();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TransformationPackage.TRANSFORMATION__TRANSFORMATION_MAPPING:
				getTransformationMapping().clear();
				getTransformationMapping().addAll((Collection<? extends TransformationMapping>)newValue);
				return;
			case TransformationPackage.TRANSFORMATION__NAME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case TransformationPackage.TRANSFORMATION__TRANSFORMATION_MAPPING:
				return transformationMapping != null && !transformationMapping.isEmpty();
			case TransformationPackage.TRANSFORMATION__NAME:
