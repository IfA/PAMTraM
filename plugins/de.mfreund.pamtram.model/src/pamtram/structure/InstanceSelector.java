...
public interface InstanceSelector extends NamedElement, ExpressionElement, ModifiableElement {
	...
	/**
	 * Returns the value of the '<em><b>Source Elements</b></em>' containment reference list. The list contents are of
	 * type {@link pamtram.structure.InstanceSelectorSourceInterface}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Source Attributes</em>' containment reference list isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> The list of 'sourceElements' based on which the reference value
	 * used by this selector is calculated. <!-- end-model-doc -->
	 * 
	 ...
	 * @generated
	 */
	boolean validateNoModifiedAttributeElementTypesInConditionModelConditions(DiagnosticChain diagnostics,
			Map<?, ?> context);
