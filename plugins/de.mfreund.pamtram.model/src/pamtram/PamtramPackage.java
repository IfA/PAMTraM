...
public interface PamtramPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PAM_TRA_M___SOURCE_SECTION_MODELS_HAVE_SAME_EPACKAGE__DIAGNOSTICCHAIN_MAP = 0;
	 ...
	 * @ordered
	 */
	int PAM_TRA_M___TARGET_SECTION_MODELS_HAVE_SAME_EPACKAGE__DIAGNOSTICCHAIN_MAP = 1;
