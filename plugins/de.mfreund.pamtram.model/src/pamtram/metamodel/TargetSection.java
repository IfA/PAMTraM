...
public interface TargetSection extends TargetSectionClass, Section<TargetSection, TargetSectionClass, TargetSectionReference, TargetSectionAttribute> {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * \n * mapping::MappingHintGroupType.allInstances()\n * ->select(mhg | self = mhg.targetSection)\n \052/\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.Executor%> executor = <%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%>.getExecutor(this);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = executor.getIdResolver();\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.Class%> TYP_pamtram_c_c_mapping_c_c_MappingHintGroupType_0 = idResolver.getClass(<%pamtram.metamodel.MetamodelTables%>.CLSSid_MappingHintGroupType, null);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.values.SetValue%> allInstances = <%org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation%>.INSTANCE.evaluate(executor, <%pamtram.metamodel.MetamodelTables%>.SET_CLSSid_MappingHintGroupType, TYP_pamtram_c_c_mapping_c_c_MappingHintGroupType_0);\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SetValue%>.Accumulator accumulator = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createSetAccumulatorValue(<%pamtram.metamodel.MetamodelTables%>.SET_CLSSid_MappingHintGroupType);\n/*@NonNull\052/ <%java.util.Iterator%><<%java.lang.Object%>> ITERATOR_mhg = allInstances.iterator();\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SetValue%> select;\nwhile (true) {\n    if (!ITERATOR_mhg.hasNext()) {\n        select = accumulator;\n        break;\n    }\n    /*@NonInvalid\052/ <%pamtram.mapping.MappingHintGroupType%> mhg = (<%pamtram.mapping.MappingHintGroupType%>)ITERATOR_mhg.next();\n    /**\n     * self = mhg.targetSection\n     \052/\n    final /*@Thrown\052/ <%pamtram.metamodel.TargetSection%> targetSection = mhg.getTargetSection();\n    final /*@Thrown\052/ boolean eq = this.equals(targetSection);\n    //\n    if (eq == <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE) {\n        accumulator.add(mhg);\n    }\n}\nfinal /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingHintGroupType%>> ECORE_select = ((<%org.eclipse.ocl.pivot.ids.IdResolver%>.IdResolverExtension)idResolver).ecoreValueOfAll(<%pamtram.mapping.MappingHintGroupType%>.class, select);\nreturn (<%org.eclipse.emf.common.util.EList%><<%pamtram.mapping.MappingHintGroupType%>>)ECORE_select;'"
	 * @generated
	 */
