 ...
 * @generated
 */
public class RegExMatcherImpl extends NamedElementImpl implements
		RegExMatcher {
	/**
	...
	public void setType(AttributeValueConstraintType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.REG_EX_MATCHER__TYPE, oldType, type));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.REG_EX_MATCHER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetamodelPackage.REG_EX_MATCHER__TYPE:
				return getType();
			case MetamodelPackage.REG_EX_MATCHER__VALUE:
				return getValue();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MetamodelPackage.REG_EX_MATCHER___CHECK_CONSTRAINT__STRING:
