...
public class BeginningMatcherImpl extends SingleReferenceValueConstraintImpl implements BeginningMatcher {
	 ...
	 * @ordered
	 */
	protected boolean caseSensitive = BeginningMatcherImpl.CASE_SENSITIVE_EDEFAULT;
	...
	public void setCaseSensitive(boolean newCaseSensitive) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					StructurePackage.BEGINNING_MATCHER__CASE_SENSITIVE, oldCaseSensitive, this.caseSensitive));
		}
	}
	...
	public void eUnset(int featureID) {
		...
		switch (featureID) {
			case StructurePackage.BEGINNING_MATCHER__CASE_SENSITIVE:
				this.setCaseSensitive(BeginningMatcherImpl.CASE_SENSITIVE_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		switch (featureID) {
			case StructurePackage.BEGINNING_MATCHER__CASE_SENSITIVE:
				return this.caseSensitive != BeginningMatcherImpl.CASE_SENSITIVE_EDEFAULT;
		}
