...
public interface PAMTraM extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * self.sourceSectionModel->collect(s | s.metaModelSections)\n \052/\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.Executor%> executor = <%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%>.getExecutor(this);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = executor.getIdResolver();\nfinal /*@Thrown\052/ <%java.util.List%><<%pamtram.SourceSectionModel%>> sourceSectionModel = this.getSourceSectionModel();\nfinal /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_sourceSectionModel = idResolver.createOrderedSetOfAll(<%pamtram.PamtramTables%>.ORD_CLSSid_SourceSectionModel, sourceSectionModel);\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SequenceValue%>.Accumulator accumulator = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createSequenceAccumulatorValue(<%pamtram.PamtramTables%>.SEQ_TMPLid_);\n/*@NonNull\052/ <%java.util.Iterator%><<%java.lang.Object%>> ITERATOR_s = BOXED_sourceSectionModel.iterator();\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SequenceValue%> collect;\nwhile (true) {\n    if (!ITERATOR_s.hasNext()) {\n        collect = accumulator;\n        break;\n    }\n    /*@NonInvalid\052/ <%pamtram.SourceSectionModel%> s = (<%pamtram.SourceSectionModel%>)ITERATOR_s.next();\n    /**\n     * s.metaModelSections\n     \052/\n    final /*@Thrown\052/ <%java.util.List%><<%java.lang.Object%>> metaModelSections = s.getMetaModelSections();\n    final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_metaModelSections = idResolver.createOrderedSetOfAll(<%pamtram.PamtramTables%>.ORD_TMPLid_, metaModelSections);\n    //\n    for (Object value : BOXED_metaModelSections.flatten().getElements()) {\n        accumulator.add(value);\n    }\n}\nfinal /*@Thrown\052/ <%java.util.List%><<%java.lang.Object%>> ECORE_collect = ((<%org.eclipse.ocl.pivot.ids.IdResolver%>.IdResolverExtension)idResolver).ecoreValueOfAll(<%java.lang.Object%>.class, collect);\nreturn (<%org.eclipse.emf.common.util.EList%><<%java.lang.Object%>>)ECORE_collect;'"
	 * @generated
	 */
	 ...
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * self.targetSectionModel->collect(s | s.metaModelSections)\n \052/\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.Executor%> executor = <%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%>.getExecutor(this);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = executor.getIdResolver();\nfinal /*@Thrown\052/ <%java.util.List%><<%pamtram.TargetSectionModel%>> targetSectionModel = this.getTargetSectionModel();\nfinal /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_targetSectionModel = idResolver.createOrderedSetOfAll(<%pamtram.PamtramTables%>.ORD_CLSSid_TargetSectionModel, targetSectionModel);\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SequenceValue%>.Accumulator accumulator = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createSequenceAccumulatorValue(<%pamtram.PamtramTables%>.SEQ_TMPLid_);\n/*@NonNull\052/ <%java.util.Iterator%><<%java.lang.Object%>> ITERATOR_s = BOXED_targetSectionModel.iterator();\n/*@Thrown\052/ <%org.eclipse.ocl.pivot.values.SequenceValue%> collect;\nwhile (true) {\n    if (!ITERATOR_s.hasNext()) {\n        collect = accumulator;\n        break;\n    }\n    /*@NonInvalid\052/ <%pamtram.TargetSectionModel%> s = (<%pamtram.TargetSectionModel%>)ITERATOR_s.next();\n    /**\n     * s.metaModelSections\n     \052/\n    final /*@Thrown\052/ <%java.util.List%><<%java.lang.Object%>> metaModelSections = s.getMetaModelSections();\n    final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_metaModelSections = idResolver.createOrderedSetOfAll(<%pamtram.PamtramTables%>.ORD_TMPLid_, metaModelSections);\n    //\n    for (Object value : BOXED_metaModelSections.flatten().getElements()) {\n        accumulator.add(value);\n    }\n}\nfinal /*@Thrown\052/ <%java.util.List%><<%java.lang.Object%>> ECORE_collect = ((<%org.eclipse.ocl.pivot.ids.IdResolver%>.IdResolverExtension)idResolver).ecoreValueOfAll(<%java.lang.Object%>.class, collect);\nreturn (<%org.eclipse.emf.common.util.EList%><<%java.lang.Object%>>)ECORE_collect;'"
	 * @generated
	 */
