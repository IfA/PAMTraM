...
public class ActualSourceSectionAttributeImpl extends SourceSectionAttributeImpl
	 ...
	 * @generated
	 */
	public ActualSourceSectionAttributeImpl() {
		super();
	}
			...
			if (this.attribute != oldAttribute) {
				if (this.eNotificationRequired()) {
					this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							StructurePackage.ACTUAL_SOURCE_SECTION_ATTRIBUTE__ATTRIBUTE, oldAttribute, this.attribute));
				}
			}
		}
		...
		if (baseClass == ActualAttribute.class) {
			switch (baseFeatureID) {
				case GenericPackage.ACTUAL_ATTRIBUTE__ATTRIBUTE:
					return StructurePackage.ACTUAL_SOURCE_SECTION_ATTRIBUTE__ATTRIBUTE;
				default:
					return -1;
			}
		}
		...
		if (baseClass == ActualAttribute.class) {
			switch (baseOperationID) {
				case GenericPackage.ACTUAL_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP:
					return StructurePackage.ACTUAL_SOURCE_SECTION_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP;
				default:
					return -1;
			}
		}
