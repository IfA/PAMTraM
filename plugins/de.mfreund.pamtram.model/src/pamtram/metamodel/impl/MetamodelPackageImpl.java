...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EOperation getSection__ContainerMatchesExtendContainer__DiagnosticChain_Map_1() {
	 ...
	 * @generated
	 */
	public EOperation getActualAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map_1() {
	...
	public void createPackageContents() {
		...
		createEOperation(sectionEClass, SECTION___CONTAINER_MATCHES_EXTEND_CONTAINER__DIAGNOSTICCHAIN_MAP_1);
		...
		createEOperation(actualAttributeEClass, ACTUAL_ATTRIBUTE___ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP_1);
	...
	public void initializePackageContents() {
		...
		regExMatcherEClass.getESuperTypes().add(thePamtramPackage.getSingleReferenceAttributeValueConstraint());
		caseSensitiveConstraintEClass.getESuperTypes().add(thePamtramPackage.getSingleReferenceAttributeValueConstraint());
		...
		op = initEOperation(getSection__ContainerMatchesExtendContainer__DiagnosticChain_Map_1(), ecorePackage.getEBoolean(), "containerMatchesExtendContainer", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getActualAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map_1(), ecorePackage.getEBoolean(), "attributeMatchesParentEClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getRangeConstraint_UpperBound(), thePamtramPackage.getRangeBound(), null, "upperBound", null, 0, 1, RangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRangeConstraint_LowerBound(), thePamtramPackage.getRangeBound(), null, "lowerBound", null, 0, 1, RangeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
