...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EOperation getInstancePointer__NoGlobalAttributeImporterInMappingConditions__DiagnosticChain_Map_3() {
	...
	public void createPackageContents() {
		...
		createEOperation(instancePointerEClass, INSTANCE_POINTER___NO_GLOBAL_ATTRIBUTE_IMPORTER_IN_MAPPING_CONDITIONS__DIAGNOSTICCHAIN_MAP_3);
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getInstancePointer__NoGlobalAttributeImporterInMappingConditions__DiagnosticChain_Map_3(), ecorePackage.getEBoolean(), "noGlobalAttributeImporterInMappingConditions", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (instancePointerEClass, 
		   source, 
		   new String[] {
			 "constraints", "noGlobalAttributeImporterInMappingConditions"
		   });
	}
