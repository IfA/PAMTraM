 ...
 * </p>
 * <ul>
 *   <li>{@link pamtram.structure.impl.InstanceSelectorExternalSourceElementImpl#getLocalCondition <em>Local Condition</em>}</li>
 *   <li>{@link pamtram.structure.impl.InstanceSelectorExternalSourceElementImpl#getSharedCondition <em>Shared Condition</em>}</li>
 *   <li>{@link pamtram.structure.impl.InstanceSelectorExternalSourceElementImpl#getAllConditions <em>All Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceSelectorExternalSourceElementImpl extends ExternalDynamicSourceElementImpl<SourceSection, SourceSectionClass, SourceSectionReference, SourceSectionAttribute> implements InstanceSelectorExternalSourceElement {
	/**
	...
	public NotificationChain basicSetLocalCondition(ComplexCondition newLocalCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION, oldLocalCondition, newLocalCondition);
	...
	public void setLocalCondition(ComplexCondition newLocalCondition) {
		...
		if (newLocalCondition != localCondition) {
			...
			if (localCondition != null)
				msgs = ((InternalEObject)localCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION, null, msgs);
			if (newLocalCondition != null)
				msgs = ((InternalEObject)newLocalCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION, null, msgs);
			msgs = basicSetLocalCondition(newLocalCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION, newLocalCondition, newLocalCondition));
	...
	public ComplexCondition getSharedCondition() {
		  ...
		  if (sharedCondition != null && sharedCondition.eIsProxy()) {
			...
			if (sharedCondition != oldSharedCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__SHARED_CONDITION, oldSharedCondition, sharedCondition));
			}
		}
	...
	public void setSharedCondition(ComplexCondition newSharedCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__SHARED_CONDITION, oldSharedCondition, sharedCondition));
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__SHARED_CONDITION:
				if (resolve) return getSharedCondition();
				return basicGetSharedCondition();
			case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__ALL_CONDITIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ConditionalElement.class) {
			switch (derivedFeatureID) {
				case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION: return PamtramPackage.CONDITIONAL_ELEMENT__LOCAL_CONDITION;
				case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__SHARED_CONDITION: return PamtramPackage.CONDITIONAL_ELEMENT__SHARED_CONDITION;
				case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__ALL_CONDITIONS: return PamtramPackage.CONDITIONAL_ELEMENT__ALL_CONDITIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ConditionalElement.class) {
			switch (baseFeatureID) {
				case PamtramPackage.CONDITIONAL_ELEMENT__LOCAL_CONDITION: return StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__LOCAL_CONDITION;
				case PamtramPackage.CONDITIONAL_ELEMENT__SHARED_CONDITION: return StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__SHARED_CONDITION;
				case PamtramPackage.CONDITIONAL_ELEMENT__ALL_CONDITIONS: return StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT__ALL_CONDITIONS;
				default: return -1;
			}
		}
		if (baseClass == MappingHintSourceInterface.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ConditionalElement.class) {
			switch (baseOperationID) {
				case PamtramPackage.CONDITIONAL_ELEMENT___VALIDATE_REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP: return StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT___VALIDATE_REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
		if (baseClass == MappingHintSourceInterface.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StructurePackage.INSTANCE_SELECTOR_EXTERNAL_SOURCE_ELEMENT___VALIDATE_REFERENCE_ONLY_CONDITIONS_FROM_CONDITION_MODEL__DIAGNOSTICCHAIN_MAP:
