...
/**
 * This command can be used to remove a {@link LibraryEntry} from the {@link TargetSectionModel}.
 * The command automatically handles the deletion of the {@link LibraryEntry} that is stored in a separate resource.
 * This resource is re-created when the command is undone and deleted when the command is redone.
 *  
 * @author mfreund
 *
 */
public class DeleteLibraryEntryCommand extends RemoveCommand {
	...
	/**
	 * This is the {@link URI} that holds the original {@link de.tud.et.ifa.agtele.genlibrary.model.genlibrary.LibraryEntry} contained in the {@link LibraryEntry}.
	 */
	 ...
	 * @param owner The {@link TargetSectionModel} that holds the {@link LibraryEntry} to be deleted.
	 * @param libraryEntry The {@link LibraryEntry} to be deleted.
	 */
	public DeleteLibraryEntryCommand(EditingDomain domain, TargetSectionModel owner,
	...
	public void doUndo() {
		try {
			...
			de.tud.et.ifa.agtele.genlibrary.model.genlibrary.LibraryEntry originalLibraryEntry =
					((LibraryEntry) this.collection.iterator().next()).getOriginalLibraryEntry();
