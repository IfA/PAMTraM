 ...
 * </p>
 * <ul>
 * <li>{@link pamtram.structure.source.impl.VirtualSourceSectionCrossReferenceImpl#isIgnoreUnmatchedElements
 * <em>Ignore Unmatched Elements</em>}</li>
 * <li>{@link pamtram.structure.source.impl.VirtualSourceSectionCrossReferenceImpl#getDerivation
 * <em>Derivation</em>}</li>
 * </ul>
 *
 * @generated
...
public class VirtualSourceSectionCrossReferenceImpl
	 ...
	 * @ordered
	 */
	protected boolean ignoreUnmatchedElements = VirtualSourceSectionCrossReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT;

	/**
	 * The default value of the '{@link #getDerivation() <em>Derivation</em>}'
	...
	/**
	 * The cached value of the '{@link #getDerivation() <em>Derivation</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDerivation()
	 * @generated
	 * @ordered
	 */
	protected String derivation = VirtualSourceSectionCrossReferenceImpl.DERIVATION_EDEFAULT;
	...
	public EList<SourceSectionClass> getValue() {
		if (this.value == null) {
			this.value = new EObjectResolvingEList<>(SourceSectionClass.class, this,
					SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__VALUE);
		}
		return this.value;
	}
	...
	public void setIgnoreUnmatchedElements(boolean newIgnoreUnmatchedElements) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__IGNORE_UNMATCHED_ELEMENTS,
					oldIgnoreUnmatchedElements, this.ignoreUnmatchedElements));
		}
	}
	...
	public void setDerivation(String newDerivation) {
		String oldDerivation = this.derivation;
		this.derivation = newDerivation;
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET,
					SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__DERIVATION, oldDerivation, this.derivation));
		}
	}
	...
	public boolean validateDerivation(final DiagnosticChain diagnostics, final Map<?, ?> context) {
		...
		if (!result && diagnostics != null) {
			...
			String errorMessage = "The specified derivation is not valid! The following error was provided: "
					+ parserException;

			diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, SourceValidator.DIAGNOSTIC_SOURCE,
					SourceValidator.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__VALIDATE_DERIVATION, errorMessage,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
			...
			return;
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__DERIVATION:
			this.setDerivation((String) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
			this.setIgnoreUnmatchedElements(VirtualSourceSectionCrossReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT);
			return;
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__DERIVATION:
			this.setDerivation(VirtualSourceSectionCrossReferenceImpl.DERIVATION_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
			return this.ignoreUnmatchedElements != VirtualSourceSectionCrossReferenceImpl.IGNORE_UNMATCHED_ELEMENTS_EDEFAULT;
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__DERIVATION:
			return VirtualSourceSectionCrossReferenceImpl.DERIVATION_EDEFAULT == null ? this.derivation != null
					: !VirtualSourceSectionCrossReferenceImpl.DERIVATION_EDEFAULT.equals(this.derivation);
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SourceSectionReference.class) {
			...
			case SourcePackage.SOURCE_SECTION_REFERENCE__IGNORE_UNMATCHED_ELEMENTS:
				return SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE__IGNORE_UNMATCHED_ELEMENTS;
			default:
				return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case SourcePackage.VIRTUAL_SOURCE_SECTION_CROSS_REFERENCE___VALIDATE_DERIVATION__DIAGNOSTICCHAIN_MAP:
			return this.validateDerivation((DiagnosticChain) arguments.get(0), (Map<?, ?>) arguments.get(1));
		}
