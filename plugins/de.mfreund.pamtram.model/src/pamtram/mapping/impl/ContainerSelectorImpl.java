...
public class ContainerSelectorImpl extends MappingHintBaseTypeImpl implements ContainerSelector {
	...
	public void setExpression(String newExpression) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.CONTAINER_SELECTOR__EXPRESSION,
	...
	public EList<ValueModifierSet> getModifiers() {
		...
		if (this.modifiers == null) {
			this.modifiers = new EObjectResolvingEList<>(ValueModifierSet.class, this,
					MappingPackage.CONTAINER_SELECTOR__MODIFIERS);
		}
	...
	public EList<ContainerSelectorTargetAttribute> getTargetAttributes() {
		...
		if (this.targetAttributes == null) {
			this.targetAttributes = new EObjectContainmentEList<>(
					ContainerSelectorTargetAttribute.class, this, MappingPackage.CONTAINER_SELECTOR__TARGET_ATTRIBUTES);
		}
	...
	public EList<InstanceSelectorSourceInterface> getSourceElements() {
		...
		if (this.sourceElements == null) {
			this.sourceElements = new EObjectContainmentEList<>(
					InstanceSelectorSourceInterface.class, this, MappingPackage.CONTAINER_SELECTOR__SOURCE_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		switch (featureID) {
			...
			case MappingPackage.CONTAINER_SELECTOR__TARGET_ATTRIBUTES:
				return ((InternalEList<?>) this.getTargetAttributes()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		switch (featureID) {
			...
			case MappingPackage.CONTAINER_SELECTOR__TARGET_ATTRIBUTES:
				...
				this.getTargetAttributes().addAll((Collection<? extends ContainerSelectorTargetAttribute>) newValue);
				return;
		}
		...
		if (baseClass == ExpressionElement.class) {
			switch (baseFeatureID) {
				case PamtramPackage.EXPRESSION_ELEMENT__EXPRESSION:
					return MappingPackage.CONTAINER_SELECTOR__EXPRESSION;
				default:
					return -1;
			}
		}
		if (baseClass == ModifiableElement.class) {
			switch (baseFeatureID) {
				case PamtramPackage.MODIFIABLE_ELEMENT__MODIFIERS:
					return MappingPackage.CONTAINER_SELECTOR__MODIFIERS;
				default:
					return -1;
			}
		}
		if (baseClass == InstanceSelector.class) {
			switch (baseFeatureID) {
				case StructurePackage.INSTANCE_SELECTOR__SOURCE_ELEMENTS:
					return MappingPackage.CONTAINER_SELECTOR__SOURCE_ELEMENTS;
				default:
					return -1;
			}
		}
		...
		if (baseClass == InstanceSelector.class) {
			switch (baseOperationID) {
				case StructurePackage.INSTANCE_SELECTOR___VALIDATE_NO_MODIFIED_ATTRIBUTE_ELEMENT_TYPES_IN_CONDITION_MODEL_CONDITIONS__DIAGNOSTICCHAIN_MAP:
					return MappingPackage.CONTAINER_SELECTOR___VALIDATE_NO_MODIFIED_ATTRIBUTE_ELEMENT_TYPES_IN_CONDITION_MODEL_CONDITIONS__DIAGNOSTICCHAIN_MAP;
				case StructurePackage.INSTANCE_SELECTOR___GET_LOCAL_SOURCE_ELEMENTS:
					return MappingPackage.CONTAINER_SELECTOR___GET_LOCAL_SOURCE_ELEMENTS;
				case StructurePackage.INSTANCE_SELECTOR___GET_EXTERNAL_SOURCE_ELEMENTS:
					return MappingPackage.CONTAINER_SELECTOR___GET_EXTERNAL_SOURCE_ELEMENTS;
				default:
					return -1;
			}
		}
