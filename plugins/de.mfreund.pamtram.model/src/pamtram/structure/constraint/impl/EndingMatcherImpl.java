...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Ending Matcher</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link pamtram.structure.constraint.impl.EndingMatcherImpl#isCaseSensitive <em>Case Sensitive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndingMatcherImpl extends SingleReferenceValueConstraintImpl implements EndingMatcher {
	 ...
	 * @ordered
	 */
	protected boolean caseSensitive = EndingMatcherImpl.CASE_SENSITIVE_EDEFAULT;
	...
	public void setCaseSensitive(boolean newCaseSensitive) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.ENDING_MATCHER__CASE_SENSITIVE,
					oldCaseSensitive, this.caseSensitive));
		}
	}
	...
	public void eUnset(int featureID) {
		...
		switch (featureID) {
			case StructurePackage.ENDING_MATCHER__CASE_SENSITIVE:
				this.setCaseSensitive(EndingMatcherImpl.CASE_SENSITIVE_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		switch (featureID) {
			case StructurePackage.ENDING_MATCHER__CASE_SENSITIVE:
				return this.caseSensitive != EndingMatcherImpl.CASE_SENSITIVE_EDEFAULT;
		}
