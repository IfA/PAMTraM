...
public class ConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Condition_attribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Condition_attribute_feature", "_UI_Condition_type"),
				 ConditionPackage.Literals.CONDITION__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		ComparatorEnum labelValue = ((Condition)object).getComparator();
