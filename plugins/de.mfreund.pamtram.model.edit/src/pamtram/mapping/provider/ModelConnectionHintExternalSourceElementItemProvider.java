 ...
 * @generated
 */
public class ModelConnectionHintExternalSourceElementItemProvider extends ExternalAttributeMappingSourceElementItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ModelConnectionHintExternalSourceElement_type") :
			getString("_UI_ModelConnectionHintExternalSourceElement_type") + " " + label;
	}
