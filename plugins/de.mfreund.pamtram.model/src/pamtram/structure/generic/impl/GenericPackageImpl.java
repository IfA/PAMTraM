...
public class GenericPackageImpl extends EPackageImpl implements GenericPackage {
	...
	public void createPackageContents() {
		...
		compositeReferenceEClass = createEClass(CONTAINMENT_REFERENCE);
		createEReference(compositeReferenceEClass, CONTAINMENT_REFERENCE__VALUE);
		createEOperation(compositeReferenceEClass, CONTAINMENT_REFERENCE___VALIDATE_EREFERENCE_IS_CONTAINMENT__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		ETypeParameter containmentReferenceEClass_S = addETypeParameter(compositeReferenceEClass, "S");
		ETypeParameter containmentReferenceEClass_C = addETypeParameter(compositeReferenceEClass, "C");
		ETypeParameter containmentReferenceEClass_R = addETypeParameter(compositeReferenceEClass, "R");
		ETypeParameter containmentReferenceEClass_A = addETypeParameter(compositeReferenceEClass, "A");
