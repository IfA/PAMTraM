 ...
 * </p>
 * <ul>
 *   <li>{@link pamtram.structure.impl.ActualTargetSectionAttributeImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (derivedFeatureID) {
				case StructurePackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE: return GenericPackage.ACTUAL_ATTRIBUTE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (baseFeatureID) {
				case GenericPackage.ACTUAL_ATTRIBUTE__ATTRIBUTE: return StructurePackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (baseOperationID) {
				case GenericPackage.ACTUAL_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP: return StructurePackage.ACTUAL_TARGET_SECTION_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
