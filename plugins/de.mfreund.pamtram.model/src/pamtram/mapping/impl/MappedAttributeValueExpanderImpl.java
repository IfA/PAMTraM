 ...
 * <ul>
 *   <li>{@link pamtram.mapping.impl.MappedAttributeValueExpanderImpl#getSourceAttribute <em>Source Attribute</em>}</li>
 *   <li>{@link pamtram.mapping.impl.MappedAttributeValueExpanderImpl#getTargetAttribute <em>Target Attribute</em>}</li>
 *   <li>{@link pamtram.mapping.impl.MappedAttributeValueExpanderImpl#getModifiers <em>Modifiers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MappedAttributeValueExpanderImpl extends HintImporterMappingHintImpl implements MappedAttributeValueExpander {
		...
		if (sourceAttribute != null && sourceAttribute.eIsProxy()) {
			...
			if (sourceAttribute != oldSourceAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
			}
		}
	...
	public void setSourceAttribute(SourceSectionAttribute newSourceAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
	}
	...
	public TargetSectionAttribute getTargetAttribute() {
		if (targetAttribute != null && targetAttribute.eIsProxy()) {
			...
			if (targetAttribute != oldTargetAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
			}
		}
	...
	public void setTargetAttribute(TargetSectionAttribute newTargetAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
	}
	...
	public EList<AttributeValueModifierSet> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectResolvingEList.Unsettable<AttributeValueModifierSet>(AttributeValueModifierSet.class, this, MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__MODIFIERS);
		}
		return modifiers;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__SOURCE_ATTRIBUTE:
				if (resolve) return getSourceAttribute();
				return basicGetSourceAttribute();
			case MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__TARGET_ATTRIBUTE:
				if (resolve) return getTargetAttribute();
				return basicGetTargetAttribute();
			case MappingPackage.MAPPED_ATTRIBUTE_VALUE_EXPANDER__MODIFIERS:
				return getModifiers();
		}
