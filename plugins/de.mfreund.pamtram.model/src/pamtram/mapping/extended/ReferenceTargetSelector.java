 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> A MappingHint that tells the transformation algorithm how determine the target
 * value(s)/instance(s) of a TargetSectionCrossReference in the course of a transformation. <br />
 * <br />
 * The target instances are thereby determined based on the specified 'matcher'. <!-- end-model-doc -->
 *
 * <p>
...
public interface ReferenceTargetSelector extends MappingHint, TargetInstanceSelector {
	...
	/**
	 * Sets the value of the '{@link pamtram.mapping.extended.ReferenceTargetSelector#getAffectedReference <em>Affected
	 * Reference</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Affected Reference</em>' reference.
	...
	/**
	 * Sets the value of the '{@link pamtram.mapping.extended.ReferenceTargetSelector#getMatcher <em>Matcher</em>}'
	 ...
	 *        this.getAffectedReference() == null || this.getAffectedReference().getEReference() == null ? true :
	 *        !this.getAffectedReference().getEReference().isContainment();\r\n\r\nif (!result &amp;&amp; diagnostics !=
	 *        null) {\r\n\r\n\tString errorMessage = \"The affected reference \'\" +
	 *        this.getAffectedReference().getName() + \"\' is no non-containment
	 *        reference!\";\r\n\r\n\tdiagnostics.add(new
	 ...
	 *        Object[] { this,
	 *        &lt;%pamtram.mapping.extended.ExtendedPackage%&gt;.Literals.REFERENCE_TARGET_SELECTOR__AFFECTED_REFERENCE
	 *        }));\r\n\r\n}\r\n\r\nreturn result;'"
	 * @generated
	 */
	 ...
	 *        {\r\n\treturn true;\r\n}\r\n\r\n&lt;%pamtram.structure.target.TargetSection%&gt; targetSection =
	 *        this.eContainer() instanceof &lt;%pamtram.mapping.MappingHintGroupType%&gt; ? ((MappingHintGroupType)
	 *        this.eContainer()).getTargetSection() : ((&lt;%pamtram.mapping.MappingHintGroupImporter%&gt;)
	 *        this.eContainer()).getHintGroup().getTargetSection();\r\n\r\nboolean result = targetSection == null ? true
	 *        : this.getAffectedReference().getContainingSection() == targetSection ||
	 *        targetSection.getExtend().contains(this.getAffectedReference().getContainingSection());\r\n\r\nif (!result
	 *        &amp;&amp; diagnostics != null) {\r\n\r\n\tString hintGroupName = this.eContainer() instanceof
	 *        MappingHintGroupType ? ((MappingHintGroupType) this.eContainer()).getName() : ((MappingHintGroupImporter)
	 *        this.eContainer()).getHintGroup().getName();\r\n\tString errorMessage = \"The affected reference \'\" +
	 *        this.getAffectedReference().getName() + \"\' is not part of the target section referenced by parent hint
	 *        group \'\" + hintGroupName + \"\'!\";\r\n\r\n\tdiagnostics.add(new
