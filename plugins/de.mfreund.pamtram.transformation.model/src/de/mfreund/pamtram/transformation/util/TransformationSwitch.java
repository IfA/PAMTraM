...
public class TransformationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TransformationPackage.TRANSFORMATION_MAPPING_HINT_GROUP: {
				TransformationMappingHintGroup transformationMappingHintGroup = (TransformationMappingHintGroup)theEObject;
				T result = caseTransformationMappingHintGroup(transformationMappingHintGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseTransformationMapping(TransformationMapping object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mapping Hint Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mapping Hint Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTransformationMappingHintGroup(TransformationMappingHintGroup object) {
		return null;
	}
