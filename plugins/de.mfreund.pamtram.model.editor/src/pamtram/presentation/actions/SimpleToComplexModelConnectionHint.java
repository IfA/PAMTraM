...
public class SimpleToComplexModelConnectionHint extends Action {

	SimpleModelConnectionHint oldHint;


	public SimpleToComplexModelConnectionHint(SimpleModelConnectionHint h) {
		super("convert to ComplexModelConnectionHint");
		oldHint=h;
	}
	...
	public void run() {
		...
		ComplexModelConnectionHintSourceElement source= (ComplexModelConnectionHintSourceElement) ePackage.getEFactoryInstance().create((EClass) ePackage.getEClassifier("ComplexModelConnectionHintSourceElement"));
		...
		if(oldHint.getModifier() != null){
			source.eSet(source.eClass().getEStructuralFeature(MappingPackage.COMPLEX_MODEL_CONNECTION_HINT_SOURCE_ELEMENT__MODIFIER), oldHint.getModifier());
		}
