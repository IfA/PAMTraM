...
public class SimpleToComplexAttributeMappingConverter implements
	...
	public ComplexAttributeMapping convert(
		...
		ComplexAttributeMappingSourceElement sourceElement = 
				(ComplexAttributeMappingSourceElement) ePackage.getEFactoryInstance().create((EClass) ePackage.getEClassifier("ComplexAttributeMappingSourceElement"));
		...
		if(source.getModifier() != null){
			sourceElement.eSet(sourceElement.eClass().getEStructuralFeature(MappingPackage.COMPLEX_ATTRIBUTE_MAPPING_SOURCE_ELEMENT__MODIFIER), source.getModifier());
		}
