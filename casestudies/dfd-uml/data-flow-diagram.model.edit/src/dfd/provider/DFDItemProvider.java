...
/**
 * This is the item provider adapter for a {@link dfd.DFD} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DFDItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DFDItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DFD"));
	}
	...
	public String getText(Object object) {
		String label = ((DFD)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DFD_type") :
			getString("_UI_DFD_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DFD.class)) {
