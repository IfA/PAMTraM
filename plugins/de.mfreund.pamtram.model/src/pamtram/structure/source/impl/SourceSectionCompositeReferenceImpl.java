 ...
 *   <li>{@link pamtram.structure.source.impl.SourceSectionCompositeReferenceImpl#getEReference <em>EReference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceSectionCompositeReferenceImpl extends
	...
	public EReference getEReference() {
		  ...
		  if (eReference != null && eReference.eIsProxy()) {
			...
			if (eReference != oldEReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE, oldEReference, eReference));
			}
		}
		return eReference;
	}
	...
	public void setEReferenceGen(EReference newEReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE, oldEReference, eReference));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ActualReference.class) {
			switch (derivedFeatureID) {
				case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE: return GenericPackage.ACTUAL_REFERENCE__EREFERENCE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ActualReference.class) {
			switch (baseFeatureID) {
				case GenericPackage.ACTUAL_REFERENCE__EREFERENCE: return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE__EREFERENCE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == SourceSectionReference.class) {
			switch (baseOperationID) {
				case SourcePackage.SOURCE_SECTION_REFERENCE___VALIDATE_IS_IGNORE_UNMATCHED_IF_IS_COMPLEMENTED__DIAGNOSTICCHAIN_MAP: return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE___VALIDATE_IS_IGNORE_UNMATCHED_IF_IS_COMPLEMENTED__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
		if (baseClass == ActualReference.class) {
			switch (baseOperationID) {
				case GenericPackage.ACTUAL_REFERENCE___VALIDATE_EREFERENCE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP: return SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE___VALIDATE_EREFERENCE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE___VALIDATE_EREFERENCE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP:
				return validateEReferenceMatchesParentEClass((DiagnosticChain)arguments.get(0), (Map<?, ?>)arguments.get(1));
			case SourcePackage.SOURCE_SECTION_COMPOSITE_REFERENCE___VALIDATE_IS_IGNORE_UNMATCHED_IF_IS_COMPLEMENTED__DIAGNOSTICCHAIN_MAP:
