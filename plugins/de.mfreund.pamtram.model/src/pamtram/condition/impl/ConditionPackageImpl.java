...
public class ConditionPackageImpl extends EPackageImpl implements ConditionPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getCondition_InstanceSelectors(), theStructurePackage.getInstanceSelector(), null, "additionalConditionSpecification", null, 0, -1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
