...
/**
 */
package pamtram.structure.constraint.presentation;
...
/**
 * This is the action bar contributor for the Constraint model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintActionBarContributor
	 ...
	 * @generated
	 */
	public ConstraintActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("constraint-settings"));
		toolBarManager.add(new Separator("constraint-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PamtramEditorPlugin.INSTANCE.getString("_UI_ConstraintEditor_menu"), "pamtram.structure.constraintMenuID");
