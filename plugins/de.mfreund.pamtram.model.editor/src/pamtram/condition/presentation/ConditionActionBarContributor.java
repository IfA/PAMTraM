...
/**
 * This is the action bar contributor for the Condition model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionActionBarContributor
	 ...
	 * @generated
	 */
	public ConditionActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("condition-settings"));
		toolBarManager.add(new Separator("condition-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(PamtramEditorPlugin.INSTANCE.getString("_UI_ConditionEditor_menu"), "pamtram.conditionMenuID");
