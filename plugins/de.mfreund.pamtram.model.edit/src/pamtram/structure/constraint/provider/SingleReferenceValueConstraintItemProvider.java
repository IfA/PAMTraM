...
public class SingleReferenceValueConstraintItemProvider extends NamedElementItemProvider {
	...
	protected void addExpressionPropertyDescriptor(Object object) {
		...
		this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
				...
				this.getString("_UI_PropertyDescriptor_description", "_UI_ExpressionHint_expression_feature",
						"_UI_ExpressionHint_type"),
				MappingPackage.Literals.EXPRESSION_HINT__EXPRESSION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
