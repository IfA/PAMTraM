 ...
 * </ul>
 *
 * @see pamtram.structure.MetamodelPackage#getSection()
 * @model abstract="true"
...
public interface Section<S extends Section<S, C, R, A>, C extends pamtram.structure.Class<S, C, R, A>, R extends Reference<S, C, R, A>, A extends Attribute<S, C, R, A>> extends pamtram.structure.Class<S, C, R, A> {
	 ...
	 * @see pamtram.structure.MetamodelPackage#getSection_Abstract()
	 ...
	 * @see pamtram.structure.MetamodelPackage#getSection_Extend()
	 * @model
	 * @generated
	 */
	EList<S> getExtend();
