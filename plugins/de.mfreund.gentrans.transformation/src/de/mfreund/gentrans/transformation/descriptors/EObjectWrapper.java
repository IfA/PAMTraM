...
/**
 * This class provides wrapper functionality for {@link EObject EObjects} that
 * have been created during the transformation and extends an EObject in a way
 * that not only values of {@link ActualAttribute ActualAttributes} but also of
 * {@link VirtualAttribute VirtualAttributes} are stored.
 * <p />
 * The class provides a common interface to set and retrieve values of
 * {@link TargetSectionAttribute} (<em>virtual</em> as well as <em>actual</em>
 * ones) via the methods
 * {@link #setAttributeValue(TargetSectionAttribute, String)} and
...
public class EObjectWrapper {
	...
	/**
	 * The {@link AttributeValueRegistry} that values to be
	 * {@link #setAttributeValue(TargetSectionAttribute, String) set} will be
	 * registered in.
	 */
	private final AttributeValueRegistry attrValRegistry;

	/**
	 * As values of {@link VirtualAttribute VirtualAttributes} cannot bestored
	 * in the actual {@link #eObject}, they are stored in a separate map.
	 */
	 ...
	 *            The {@link AttributeValueRegistry} that values to be
	 *            {@link #setAttributeValue(TargetSectionAttribute, String) set}
	 *            will be registered in.
	 */
	public EObjectWrapper(EObject eObject, final AttributeValueRegistry attrValRegistry) {
	...
	/**
	 * This returns a String representation of the value of a
	 * {@link TargetSectionAttribute}.
	 * <p />
	 * If the given 'attr' is an {@link ActualAttribute} the actual value of the
	 * wrapped {@link #eObject} is returned - if 'attr' is an
	 * {@link VirtualAttribute} the value that is stored in
	...
	/**
	 * This checks if the given attribute 'value' has been already registered to
	 * the {@link #attrValRegistry} that is associated with this wrapper for the
	 * given 'attr'.
	 *
	 * @param attr
	 *            The {@link TargetSectionAttribute} for that the registry shall
	 *            be consulted.
	 * @param value
	 *            The attribute value to be checked.
	 * @return '<em><b>true</b><em>' if the given 'value' has been registered
	 *         before for the given 'attr', '<em><b>false</b></em>' otherwise.
	 */
	...
	/**
	 * This sets the value of a {@link TargetSectionAttribute} and registers it
	 * in the {@link #attrValRegistry} registered with this wrapper.
	 * <p />
	 * Based on the attribute type, this redirect to
	 * {@link #setAttributeValue(ActualAttribute, String)} or to
	 * {@link #setAttributeValue(VirtualAttribute, String)}.
	 *
	 * @param attr
	 *            The {@link TargetSectionAttribute} for that the given 'value'
	 *            shall be set.
	 * @param value
	 ...
	 * <p />
	 * <b>Note:</b> The given value will be set in the {@link #eObject} that is
	 * wrapped by this.
	 *
	 * @param attr
	 *            The {@link ActualAttribute} for that the given 'value' shall
	 *            be set.
	 * @param value
	 *            A String representation of the value to be set. This will be
	 *            converted to the correct data type defined by 'attr'.
	 * @throws IllegalArgumentException
	 *             If the given 'value' cannot be converted to the data type
	 *             defined by 'attr'.
	 */
	 ...
	 *
	 * @param attr
	 *            The {@link VirtualAttribute} for that the given 'value' shall
	 *            be set.
	 * @param value
	 *            The value to be set.
	 */
	...
	/**
	 * This creates a String representation of an EObject that includes the
	 * values of all {@link ActualAttribute ActualAttributes}.
	 *
	 * @param eObject
	 *            The {@link EObject} for that the String representation shall
	 *            be created.
	...
	/**
	 * Static helper method for converting an attribute value of the given
	 * 'eObject' to a String representation.
	 *
	 * @param eObject
	 *            The {@link EObject} for that the attribute value shall be
	 *            returned.
	 * @param attr
	...
	/**
	 * If this represents a {@link TargetSection}, return the value of the
	 * {@link FileAttribute} associated with this via the
	 * {@link TargetSection#getFile() file} reference.
	 *
	 * @return The value of the {@link FileAttribute} or an empty String if this
	 *         either does not represent a {@link TargetSection} or if the
	 *         {@link TargetSection#getFile() file} reference has not been set.
	 */
	...
	/**
	 * If this represents a {@link TargetSection}, return the
	 * {@link FileAttribute#getFileType() fileType} of the {@link FileAttribute}
	 * associated with this via the {@link TargetSection#getFile() file}
	 * reference.
	 *
	 * @return The value of the {@link FileAttribute#getFileType()} or the
	 *         default value {@link FileType#XMI} if this either does not
	 *         represent a {@link TargetSection}, if the
	 *         {@link TargetSection#getFile() file} reference has not been set,
	 *         or if no {@link FileAttribute#getFileType()} fileType has been
	 *         set.
	 */
