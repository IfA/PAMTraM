...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EReference getActualSourceSectionAttribute_ValueConstraint() {
	...
	public EReference getActualSourceSectionAttribute_Attribute() {
		return (EReference)actualSourceSectionAttributeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getActualSourceSectionAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map_2() {
	 ...
	 * @generated
	 */
	public EOperation getInstancePointer__NoModifiedAttributeElementTypesInConditionModelConditions__DiagnosticChain_Map_4() {
	...
	public void createPackageContents() {
		...
		createEReference(actualSourceSectionAttributeEClass, ACTUAL_SOURCE_SECTION_ATTRIBUTE__VALUE_CONSTRAINT);
		createEReference(actualSourceSectionAttributeEClass, ACTUAL_SOURCE_SECTION_ATTRIBUTE__ATTRIBUTE);
		createEOperation(actualSourceSectionAttributeEClass, ACTUAL_SOURCE_SECTION_ATTRIBUTE___ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP_2);
		...
		createEOperation(instancePointerEClass, INSTANCE_POINTER___NO_MODIFIED_ATTRIBUTE_ELEMENT_TYPES_IN_CONDITION_MODEL_CONDITIONS__DIAGNOSTICCHAIN_MAP_4);
	...
	public void initializePackageContents() {
		...
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(this.getActualSourceSectionAttribute());
		g1.getETypeArguments().add(g2);
		sourceSectionEClass.getEGenericSuperTypes().add(g1);
		...
		initEReference(getActualSourceSectionAttribute_ValueConstraint(), this.getAttributeValueConstraint(), null, "valueConstraint", null, 0, -1, ActualSourceSectionAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getActualSourceSectionAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map_2(), ecorePackage.getEBoolean(), "attributeMatchesParentEClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getInstancePointer__NoModifiedAttributeElementTypesInConditionModelConditions__DiagnosticChain_Map_4(), ecorePackage.getEBoolean(), "noModifiedAttributeElementTypesInConditionModelConditions", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
