...
public class SourceInstanceSelectorItemProvider extends InstanceSelectorItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceInstanceSelector_referenceAttribute_feature"),
				 getString("_UI_SourceInstanceSelector_referenceAttribute_description"),
				 StructurePackage.Literals.SOURCE_INSTANCE_SELECTOR__REFERENCE_ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SourceInstanceSelector_targetClass_feature"),
				 getString("_UI_SourceInstanceSelector_targetClass_description"),
				 StructurePackage.Literals.SOURCE_INSTANCE_SELECTOR__TARGET_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getStyledText(Object object) {
		String label = ((SourceInstanceSelector)object).getName();
