...
public interface Mapping extends MappingType, ConditionalElement {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='/**\n * \n * inv containsDeactivatedHintGroups:\n *   let severity : Integer[1] = 2\n *   in\n *     let\n *       status : OclAny[?] = if self.deactivated = false\n *       then\n *         self.mappingHintGroups->size() =\n *         self.getActiveMappingHintGroups()\n *         ->size() and\n *         self.importedMappingHintGroups->size() =\n *         self.getActiveImportedMappingHintGroups()\n *         ->size()\n *       else true\n *       endif\n *     in\n *       let\n *         message : String[?] = if status <> true\n *         then \'The mapping contains deactivated hint groups that will not be used in a transformation!\'\n *         else null\n *         endif\n *       in\n *         \'Mapping::containsDeactivatedHintGroups\'.logDiagnostic(self, null, diagnostics, context, message, severity, status, 0)\n \052/\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.evaluation.Executor%> executor = <%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%>.getExecutor(this);\nfinal /*@NonInvalid\052/ <%org.eclipse.ocl.pivot.ids.IdResolver%> idResolver = executor.getIdResolver();\n/*@Caught\052/ /*@Nullable\052/ <%java.lang.Object%> CAUGHT_status;\ntry {\n    final /*@Thrown\052/ boolean deactivated = this.isDeactivated();\n    final /*@Thrown\052/ boolean eq = !deactivated;\n    /*@Thrown\052/ <%java.lang.Boolean%> status;\n    if (eq) {\n        /*@Caught\052/ /*@NonNull\052/ <%java.lang.Object%> CAUGHT_eq_0;\n        try {\n            final /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingHintGroupType%>> mappingHintGroups = this.getMappingHintGroups();\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_mappingHintGroups = idResolver.createOrderedSetOfAll(<%pamtram.mapping.MappingTables%>.ORD_CLSSid_MappingHintGroupType, mappingHintGroups);\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size = <%org.eclipse.ocl.pivot.library.collection.CollectionSizeOperation%>.INSTANCE.evaluate(BOXED_mappingHintGroups);\n            final /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingHintGroupType%>> getActiveMappingHintGroups = this.getActiveMappingHintGroups();\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_getActiveMappingHintGroups = idResolver.createOrderedSetOfAll(<%pamtram.mapping.MappingTables%>.ORD_CLSSid_MappingHintGroupType, getActiveMappingHintGroups);\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size_0 = <%org.eclipse.ocl.pivot.library.collection.CollectionSizeOperation%>.INSTANCE.evaluate(BOXED_getActiveMappingHintGroups);\n            final /*@Thrown\052/ boolean eq_0 = size.equals(size_0);\n            CAUGHT_eq_0 = eq_0;\n        }\n        catch (<%java.lang.Exception%> e) {\n            CAUGHT_eq_0 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n        }\n        /*@Caught\052/ /*@NonNull\052/ <%java.lang.Object%> CAUGHT_eq_1;\n        try {\n            final /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingHintGroupImporter%>> importedMappingHintGroups = this.getImportedMappingHintGroups();\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_importedMappingHintGroups = idResolver.createOrderedSetOfAll(<%pamtram.mapping.MappingTables%>.ORD_CLSSid_MappingHintGroupImporter, importedMappingHintGroups);\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size_1 = <%org.eclipse.ocl.pivot.library.collection.CollectionSizeOperation%>.INSTANCE.evaluate(BOXED_importedMappingHintGroups);\n            final /*@Thrown\052/ <%java.util.List%><<%pamtram.mapping.MappingHintGroupImporter%>> getActiveImportedMappingHintGroups = this.getActiveImportedMappingHintGroups();\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.OrderedSetValue%> BOXED_getActiveImportedMappingHintGroups = idResolver.createOrderedSetOfAll(<%pamtram.mapping.MappingTables%>.ORD_CLSSid_MappingHintGroupImporter, getActiveImportedMappingHintGroups);\n            final /*@Thrown\052/ <%org.eclipse.ocl.pivot.values.IntegerValue%> size_2 = <%org.eclipse.ocl.pivot.library.collection.CollectionSizeOperation%>.INSTANCE.evaluate(BOXED_getActiveImportedMappingHintGroups);\n            final /*@Thrown\052/ boolean eq_1 = size_1.equals(size_2);\n            CAUGHT_eq_1 = eq_1;\n        }\n        catch (<%java.lang.Exception%> e) {\n            CAUGHT_eq_1 = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n        }\n        final /*@Thrown\052/ <%java.lang.Boolean%> and = <%org.eclipse.ocl.pivot.library.logical.BooleanAndOperation%>.INSTANCE.evaluate(CAUGHT_eq_0, CAUGHT_eq_1);\n        status = and;\n    }\n    else {\n        status = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.TRUE_VALUE;\n    }\n    CAUGHT_status = status;\n}\ncatch (<%java.lang.Exception%> e) {\n    CAUGHT_status = <%org.eclipse.ocl.pivot.utilities.ValueUtil%>.createInvalidValue(e);\n}\nif (CAUGHT_status instanceof <%org.eclipse.ocl.pivot.values.InvalidValueException%>) {\n    throw (<%org.eclipse.ocl.pivot.values.InvalidValueException%>)CAUGHT_status;\n}\nfinal /*@Thrown\052/ boolean ne = CAUGHT_status == Boolean.FALSE;\n/*@NonInvalid\052/ <%java.lang.String%> message_0;\nif (ne) {\n    message_0 = <%pamtram.mapping.MappingTables%>.STR_The_32_mapping_32_contains_32_deactivated_32_hint_32_groups_32_that_32_will_32_not_32_be_32_us;\n}\nelse {\n    message_0 = null;\n}\nfinal /*@NonInvalid\052/ boolean logDiagnostic = <%org.eclipse.ocl.pivot.library.string.CGStringLogDiagnosticOperation%>.INSTANCE.evaluate(executor, <%org.eclipse.ocl.pivot.ids.TypeId%>.BOOLEAN, <%pamtram.mapping.MappingTables%>.STR_Mapping_c_c_containsDeactivatedHintGroups, this, null, diagnostics, context, message_0, <%pamtram.mapping.MappingTables%>.INT_2, CAUGHT_status, <%pamtram.mapping.MappingTables%>.INT_0).booleanValue();\nreturn Boolean.TRUE == logDiagnostic;'"
	 * @generated
	 */
