...
public interface ActualTargetSectionAttribute extends TargetSectionAttribute, ActualAttribute<TargetSection, TargetSectionClass, TargetSectionReference, TargetSectionAttribute> {
	 ...
	 * @see pamtram.metamodel.MetamodelPackage#getActualTargetSectionAttribute_Attribute()
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://mfreund.de/pamtram/metamodel!ActualTargetSectionAttribute!attribute'"
	 * @generated
	 */
