...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EOperation getSection__ExtendsValidSections__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getSourceSection__IsReferencedByMapping__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getTargetSection__IsReferencedByMappingHintGroup__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EReference getActualTargetSectionAttribute_Attribute() {
		return (EReference)actualTargetSectionAttributeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getActualTargetSectionAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map() {
		return actualTargetSectionAttributeEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(sectionEClass, SECTION___EXTENDS_VALID_SECTIONS__DIAGNOSTICCHAIN_MAP);

		sourceSectionEClass = createEClass(SOURCE_SECTION);
		createEReference(sourceSectionEClass, SOURCE_SECTION__REFERENCING_MAPPINGS);
		createEOperation(sourceSectionEClass, SOURCE_SECTION___IS_REFERENCED_BY_MAPPING__DIAGNOSTICCHAIN_MAP);
		...
		createEReference(actualTargetSectionAttributeEClass, ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE);
		createEOperation(actualTargetSectionAttributeEClass, ACTUAL_TARGET_SECTION_ATTRIBUTE___ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		op = initEOperation(getSection__ExtendsValidSections__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "extendsValidSections", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getSourceSection__IsReferencedByMapping__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "isReferencedByMapping", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getTargetSection__IsReferencedByMappingHintGroup__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "isReferencedByMappingHintGroup", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getActualTargetSectionAttribute_Attribute(), ecorePackage.getEAttribute(), null, "attribute", null, 1, 1, ActualTargetSectionAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getActualTargetSectionAttribute__AttributeMatchesParentEClass__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "attributeMatchesParentEClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
