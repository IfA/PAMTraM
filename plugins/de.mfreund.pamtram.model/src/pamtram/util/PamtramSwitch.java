...
public class PamtramSwitch<T> extends Switch<T> {
	 ...
	 * @generated
	 */
	public <S extends Section<S, C, R, A>, C extends pamtram.structure.Class<S, C, R, A>, R extends Reference<S, C, R, A>, A extends Attribute<S, C, R, A>> T caseSectionModel(SectionModel<S, C, R, A> object) {
		return null;
	}
