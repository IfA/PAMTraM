		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeMapping_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeMapping_source_feature", "_UI_AttributeMapping_type"),
	...
	protected void addModifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleAttributeMapping_modifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleAttributeMapping_modifier_feature", "_UI_SimpleAttributeMapping_type"),
				 MappingPackage.Literals.SIMPLE_ATTRIBUTE_MAPPING__MODIFIER,
				 true,
				 false,
				 true,
				 null,
