...
public class ActualTargetSectionAttributeImpl extends TargetSectionAttributeImpl
	...
	protected EClass eStaticClass() {
		return TargetPackage.Literals.ACTUAL_TARGET_SECTION_ATTRIBUTE;
	}
		  ...
		  if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (derivedFeatureID) {
				case TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE: return GenericPackage.ACTUAL_ATTRIBUTE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (baseFeatureID) {
				case GenericPackage.ACTUAL_ATTRIBUTE__ATTRIBUTE: return TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE__ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ActualAttribute.class) {
			switch (baseOperationID) {
				case GenericPackage.ACTUAL_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP: return TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TargetPackage.ACTUAL_TARGET_SECTION_ATTRIBUTE___VALIDATE_ATTRIBUTE_MATCHES_PARENT_ECLASS__DIAGNOSTICCHAIN_MAP:
